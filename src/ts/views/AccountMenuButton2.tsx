...
export default class AccountMenuButton2 extends ComponentBase<AccountMenuButtonProps, AccountMenuButtonState> {
    ...
    render(): JSX.Element | null {
        ...
        return (
            ...
            )} style={{ content: [{ width: 180, height: 37, justifyContent: 'flex-start', alignItems: 'center', borderRadius: 11, }], label: _styles.label }
            } elevation={4} variant={"outlined"} label={this.props.username.length > 8 ? this.props.username.substring(0, 5).toUpperCase() + '...' + this.props.username.substring(leng - 3, leng).toUpperCase() : this.props.username} />
