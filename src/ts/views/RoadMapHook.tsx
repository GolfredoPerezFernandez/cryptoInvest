...
export const RoadMapHook = ({
  ...
  return <RX.ScrollView style={{ flex: 1, backgroundColor: 'black', alignSelf: 'stretch' }} >
    ...
    {isTiny ?
      ...
      <RX.View style={{ flex: 1, width: width, height: width < 700 ? height * 3.7 : height * 2.4, borderColor: "#FFC06F", justifyContent: 'center', alignItems: 'center', alignSelf: 'stretch' }} >
        ...
        <RX.View style={{ borderLeftWidth: 5, borderTopWidth: 0, borderBottomWidth: 0, borderRightWidth: 0, paddingLeft: 20, borderColor: '#FFC06F', justifyContent: 'center', alignItems: 'center' }}>
          <RX.View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <RX.Text style={[_styles.logoText6, { minWidth: 180, textAlign: 'left', marginTop: 40, width: width < 700 ? 180 : 350, marginBottom: 5, }]}>
              {'#1 Preparation'}
            </RX.Text>
          </RX.View>

          <RX.Text style={[_styles.logoText4, { minWidth: 180, width: width < 700 ? 180 : 350 }]}>
          ...
          <RX.Text style={[_styles.logoText6, { minWidth: 200, textAlign: 'left', marginTop: 40, width: width < 700 ? 180 : 350, marginBottom: 5, }]}>
      ...
      </RX.View > : <RX.View style={{ flex: 1, width: width, height: width < 1200 ? (height * 2) : (height * 1.8), marginBottom: 50, borderColor: "#FFC06F", justifyContent: 'flex-start', paddingTop: 100, alignItems: 'center', alignSelf: 'center' }} >
