  ...
  return <RX.ScrollView style={{ flex: 1, backgroundColor: 'black', alignSelf: 'stretch' }} >

    {
      isTiny ?
        ...
        <RX.View style={{ flex: 1, width: width, height: (height * 1.8), marginBottom: 100, paddingTop: 20, borderColor: "#FFC06F", justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }} >
