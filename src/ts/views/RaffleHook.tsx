...
export const RaffleHook = ({

}: {
}) => {
  return <RX.View style={{ flex: 1, backgroundColor: 'black', justifyContent: 'center', alignItems: 'center', alignSelf: 'stretch' }} >
    <RX.Text style={_styles.logoText8}>{"raffles"}</RX.Text>
  </RX.View >
