        ...
        return (
            <RX.View useSafeInsets={true} style={_styles.container}>
                ...
                <RX.View style={_styles.todoListHeader2}>
                    ...
                    <RX.Image source={ImageSource.moralis} resizeMode={'contain'} resizeMethod={'auto'} style={{ width: 300, marginLeft: 0, marginBottom: 0, height: 40, }} />

                </RX.View>

                <UI.Button onPress={this._onPressCreateNewTodo2} style={{ root: [{ marginLeft: 10, marginRight: 35 }], content: [{ height: 37, backgroundColor: 'white', width: 250, marginBottom: 5, borderRadius: 11, }], label: _styles.label }
                } elevation={4} variant={"outlined"} label="Refresh All" />

                <RX.View style={_styles.todoListHeader}>

                    <RX.Text style={[_styles.text1, { marginTop: 10 }]} >
                        {'Total owners: ' + this.state.todos.length}
                    </RX.Text>

                    <RX.Text style={[_styles.text1, { marginLeft: 30, marginTop: 10, }]} >
